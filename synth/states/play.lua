...
return play_statelocal synth = require("lib/synthesizer")
local l  = love --making it local speeds up access
local lg = l.graphics --shortforms
local la = l.audio
...
local play_state = {
	...
	draw = function()
		--borders
		--instrument and range
		lg.rectangle("line", 0, 0, max_x, 18)
		--ADSR
		lg.rectangle("line", 0, 21, 58, 34)
		--waveform visualization
		lg.rectangle("line", 61, 21, 66, 34)
		--keymap outline
		lg.rectangle("line", 0, 58, max_x -1, 68)
		...
		local draw_key = function(x,y,i,index)
			...
			--grey out root note and right side
			local c = (i == 2 or index > 4) and .5 or 1
			lg.setColor(c,c,c)
